...
export default function AdminComposicaoVendaDireta() {
  ...
  const handleSalvar = () => {
    ...
    toast({
      ...
      description: "A composição da venda direta foi atualizada com sucesso.",
    });
  };
          ...
          <CardHeader>
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-primary">R$ {valorTotal.toFixed(2).replace('.', ',')}</p>
              </div>
            </div>
          </CardHeader>
        </Card>
